...
Function Increment(ObjectReference akSenderRef)
  If MaintainTargetValue ; #DEBUG_LINE_NO:5
    (Self.GetOwningQuest() as defaultcounterquesta).TargetValue = Self.GetCount() ; #DEBUG_LINE_NO:6
  EndIf ; #DEBUG_LINE_NO:
  (Self.GetOwningQuest() as defaultcounterquesta).Increment() ; #DEBUG_LINE_NO:8
  If RemoveWhenDead ; #DEBUG_LINE_NO:9
    Self.RemoveRef(akSenderRef) ; #DEBUG_LINE_NO:10
    If MaintainTargetValue ; #DEBUG_LINE_NO:11
      (Self.GetOwningQuest() as defaultcounterquesta).Decrement() ; #DEBUG_LINE_NO:12
    EndIf ; #DEBUG_LINE_NO:
  EndIf ; #DEBUG_LINE_NO:
