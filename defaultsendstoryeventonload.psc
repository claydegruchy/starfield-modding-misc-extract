...
Event OnInit()
  SkipBusyState = True ; #DEBUG_LINE_NO:29
EndEvent

Event OnLoad()
  defaultscriptfunctions:parentscriptfunctionparams ParentScriptFunctionParams = defaultscriptfunctions.BuildParentScriptFunctionParams(Self as ObjectReference, Self.GetCurrentLocation(), None) ; #DEBUG_LINE_NO:36
...
Function DoSpecificThing(defaultscriptfunctions:parentscriptfunctionparams ParentScriptFunctionParams, ObjectReference RefToDoThingWith, Bool LastRefToDoThingWith)
  Location akLoc = ParentScriptFunctionParams.LocationToCheck ; #DEBUG_LINE_NO:46
  ObjectReference akRef1 = Self as ObjectReference ; #DEBUG_LINE_NO:47
  Int aiValue1 = Value1 ; #DEBUG_LINE_NO:48
  Int aiValue2 = Value2 ; #DEBUG_LINE_NO:49
  Quest[] startedQuests = StoryEventKeyword.SendStoryEventAndWait(akLoc, akRef1, None, aiValue1, aiValue2) ; #DEBUG_LINE_NO:53
  Bool success = startedQuests.Length > 0 ; #DEBUG_LINE_NO:54
EndFunction
