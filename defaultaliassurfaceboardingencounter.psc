...
Event OnShipLanding(Bool abComplete)
  If abComplete ; #DEBUG_LINE_NO:25
    spaceshipreference myShip = Self.GetRef() as spaceshipreference ; #DEBUG_LINE_NO:26
    If myShip != None ; #DEBUG_LINE_NO:27
      BEEncounterTypeSurface.SendStoryEventAndWait(None, None, Self.GetRef(), (CrewSizePercent * 100.0) as Int, 0) ; #DEBUG_LINE_NO:29
    EndIf ; #DEBUG_LINE_NO:
  EndIf ; #DEBUG_LINE_NO:
EndEvent
