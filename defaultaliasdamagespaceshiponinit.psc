...
Auto State Waiting
  ...
  Event OnAliasInit()
    ...
    spaceshipreference myShip = Self.GetRef() as spaceshipreference ; #DEBUG_LINE_NO:41
    If myShip == None ; #DEBUG_LINE_NO:42
       ; #DEBUG_LINE_NO:
    Else ; #DEBUG_LINE_NO:
      SQ_Parent.SetupDamagedShip(myShip, ShouldBeDestroyed, ShouldBeDerelict, ShouldApplyDerelictName, ShouldDamageRandomSystems, ShouldDisableExteriorLights, ShouldBlockRepairOfDestroyedParts, AdditionalActorValuesToDamage) ; #DEBUG_LINE_NO:45
    EndIf ; #DEBUG_LINE_NO:
  EndEvent
EndState
