...
Function Fragment_Begin()
  ...
  VideoActorRefAlias.GetActorRef().EquipItem(Spacesuit_Constellation_Backpack as Form, False, False) ; #DEBUG_LINE_NO:8
  VideoActorRefAlias.GetActorRef().EquipItem(Grendel as Form, False, False) ; #DEBUG_LINE_NO:9
EndFunction
