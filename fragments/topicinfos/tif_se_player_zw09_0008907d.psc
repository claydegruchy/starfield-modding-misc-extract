...
Function Fragment_End(ObjectReference akSpeakerRef)
  ...
  Game.getplayer().RemoveItem(Game.GetCredits() as Form, 50000, False, None) ; #DEBUG_LINE_NO:8
  Game.getplayer().AddItem(Pse_zw09_Powerplant_Warranty as Form, 1, False) ; #DEBUG_LINE_NO:9
