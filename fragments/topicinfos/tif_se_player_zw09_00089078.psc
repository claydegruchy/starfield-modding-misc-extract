...
Function Fragment_End(ObjectReference akSpeakerRef)
  ...
  Game.getplayer().RemoveItem(Game.GetCredits() as Form, 200000, False, None) ; #DEBUG_LINE_NO:8
  Game.getplayer().AddItem(Pse_player_zw09_Platinum_Warranty as Form, 1, False) ; #DEBUG_LINE_NO:9
