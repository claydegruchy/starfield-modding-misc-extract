ScriptName Fragments:Quests:QF_UC_NA_CL_ArchivesScene_00001736 Extends Quest Const hidden
...
Function Fragment_Stage_0999_Item_00()
  ...
  Alias_RecruitM02.GetRef().Disable(False) ; #DEBUG_LINE_NO:18
  Alias_AudienceM02Freestar.GetRef().Disable(False) ; #DEBUG_LINE_NO:19
  Alias_Trigger.GetRef().Disable(False) ; #DEBUG_LINE_NO:20
