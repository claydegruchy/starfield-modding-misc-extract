ScriptName Fragments:Quests:QF_City_NA_FAB_Quest14_000EC267 Extends Quest Const hidden
...
ReferenceAlias Property Alias_WaitingCustomer Auto Const mandatory

;-- Functions ---------------------------------------

Function Fragment_Stage_0001_Item_00()
  Alias_Actor01.GetRef().Enable(False) ; #DEBUG_LINE_NO:7
  Alias_WaitingCustomer.GetRef().Enable(False) ; #DEBUG_LINE_NO:8
EndFunction
...
Function Fragment_Stage_9000_Item_00()
  ...
  Alias_WaitingCustomer.GetRef().Disable(False) ; #DEBUG_LINE_NO:41
