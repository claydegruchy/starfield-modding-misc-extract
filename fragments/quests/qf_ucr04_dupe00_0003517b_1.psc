ScriptName Fragments:Quests:QF_UCR04_Dupe00_0003517B_1 Extends Quest Const hidden
...
Function Fragment_Stage_0500_Item_00()
  ...
  Self.SetObjectiveDisplayed(111, False, False) ; #DEBUG_LINE_NO:59
  Self.SetObjectiveDisplayed(500, True, False) ; #DEBUG_LINE_NO:60
  Alias_DropOffNPC.GetRef().Enable(False) ; #DEBUG_LINE_NO:63
EndFunction

Function Fragment_Stage_0999_Item_00()
  Game.GetPlayer().RemovePerk(UCR04_HarvestSamplePerk) ; #DEBUG_LINE_NO:71
  ObjectReference XBRef = Alias_DropOffNPC.GetRef() ; #DEBUG_LINE_NO:74
  If !XBRef.Is3DLoaded() && XBRef.IsEnabled() ; #DEBUG_LINE_NO:75
    XBRef.Disable(False) ; #DEBUG_LINE_NO:76
  EndIf ; #DEBUG_LINE_NO:
  Self.Stop() ; #DEBUG_LINE_NO:79
EndFunction

Function Fragment_Stage_1000_Item_00()
  ObjectReference PlayREF = Game.GetPlayer() as ObjectReference ; #DEBUG_LINE_NO:87
  PlayREF.RemoveItem(UCR04_SpecimenSample as Form, PlayREF.GetItemCount(UCR04_SpecimenSample as Form), False, None) ; #DEBUG_LINE_NO:88
  Game.GetPlayer().RemovePerk(UCR04_HarvestSamplePerk) ; #DEBUG_LINE_NO:90
  ObjectReference XBRef = Alias_DropOffNPC.GetRef() ; #DEBUG_LINE_NO:93
  If !XBRef.Is3DLoaded() && XBRef.IsEnabled() ; #DEBUG_LINE_NO:94
    XBRef.Disable(False) ; #DEBUG_LINE_NO:95
  EndIf ; #DEBUG_LINE_NO:
  UCR04_TimesCompleted.SetValue(UCR04_TimesCompleted.GetValue() + 1.0) ; #DEBUG_LINE_NO:98
  Self.CompleteAllObjectives() ; #DEBUG_LINE_NO:99
  Self.Stop() ; #DEBUG_LINE_NO:100
EndFunction
