ScriptName Fragments:Quests:QF_FC_Neon_CT_CityLife_Encou_000F8A95 Extends Quest Const hidden
...
Function Fragment_Stage_9000_Item_00()
  Alias_EnableMarker.GetRef().Disable(False) ; #DEBUG_LINE_NO:39
  Self.Stop() ; #DEBUG_LINE_NO:41
EndFunction
