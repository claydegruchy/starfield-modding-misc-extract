ScriptName Fragments:Quests:QF_BE_Player_DerelictShip_Mi_0002BF41 Extends Quest Const hidden
...
Function Fragment_Stage_0010_Item_00()
  ...
  SE_GenericDerelict_MissionCrewTypeGlobal.SetValue(0.0) ; #DEBUG_LINE_NO:299
...
Function Fragment_Stage_0014_Item_00()
  ...
  bescript kmyQuest = __temp as bescript ; #DEBUG_LINE_NO:315
  SE_GenericDerelict_HazardFixed.SetValue(1.0) ; #DEBUG_LINE_NO:318
EndFunction

Function Fragment_Stage_0015_Item_00()
  Quest __temp = Self as Quest ; #DEBUG_LINE_NO:326
  bescript kmyQuest = __temp as bescript ; #DEBUG_LINE_NO:327
  ShipPowerOn.Play(Game.GetPlayer() as ObjectReference, None, None) ; #DEBUG_LINE_NO:330
  kmyQuest.SetShipHazard(None) ; #DEBUG_LINE_NO:331
  Alias_Robots.KillAll(None) ; #DEBUG_LINE_NO:332
  SE_GenericDerelict_HazardFixed.SetValue(1.0) ; #DEBUG_LINE_NO:333
  Game.GetPlayer().RemoveItem(Alias_RepairItem.GetRef() as Form, 1, False, None) ; #DEBUG_LINE_NO:334
  spaceshipreference myShip = Alias_enemyShip.GetShipRef() ; #DEBUG_LINE_NO:335
  Alias_PilotSeat.GetRef().RemoveKeyword(BlockPlayerActivation) ; #DEBUG_LINE_NO:336
  myShip.SetValue(Health, 50000.0) ; #DEBUG_LINE_NO:337
  myShip.SetValue(ShipSystemGravDriveHealth, 50000.0) ; #DEBUG_LINE_NO:338
  myShip.SetValue(ShieldHealth, 50000.0) ; #DEBUG_LINE_NO:339
EndFunction

Function Fragment_Stage_0020_Item_00()
  Quest __temp = Self as Quest ; #DEBUG_LINE_NO:347
  bescript kmyQuest = __temp as bescript ; #DEBUG_LINE_NO:348
  Game.GetPlayer().RemoveItem(ShipRepairKit as Form, 1, False, None) ; #DEBUG_LINE_NO:351
  SE_GenericDerelict_Repaired.SetValue(1.0) ; #DEBUG_LINE_NO:352
  ObjectReference TerminalRef = Alias_Terminal.GetRef() ; #DEBUG_LINE_NO:353
  TerminalRef.SetLinkedRef(Alias_CaptainsLocker.GetRef(), None, True) ; #DEBUG_LINE_NO:354
  kmyQuest.SetShipGravity(1.0) ; #DEBUG_LINE_NO:355
EndFunction

Function Fragment_Stage_0020_Item_01()
  spaceshipreference myShip = Alias_enemyShip.GetShipRef() ; #DEBUG_LINE_NO:363
  Alias_PilotSeat.GetRef().RemoveKeyword(BlockPlayerActivation) ; #DEBUG_LINE_NO:364
  myShip.SetValue(Health, 50000.0) ; #DEBUG_LINE_NO:365
  myShip.SetValue(ShipSystemGravDriveHealth, 50000.0) ; #DEBUG_LINE_NO:366
  myShip.SetValue(ShieldHealth, 50000.0) ; #DEBUG_LINE_NO:367
EndFunction

Function Fragment_Stage_0030_Item_00()
  Alias_CaptainsLocker.GetRef().Lock(False, False, True) ; #DEBUG_LINE_NO:375
EndFunction

Function Fragment_Stage_0040_Item_00()
  Self.SetStage(4) ; #DEBUG_LINE_NO:383
EndFunction

Function Fragment_Stage_1000_Item_00()
  Alias_Terminal.GetRef().DisableNoWait(False) ; #DEBUG_LINE_NO:391
EndFunction
